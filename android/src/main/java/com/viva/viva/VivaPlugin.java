...
import android.content.Context;
/** VivaPlugin */
public class VivaPlugin extends FlutterActivity implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    channelIsScan = new EventChannel(flutterPluginBinding.getBinaryMessenger(), STREAMISSCAN);
    ...
    channelScan = new EventChannel(flutterPluginBinding.getBinaryMessenger(), STREAMSCAN);
    ...
    channelConnession = new EventChannel(flutterPluginBinding.getBinaryMessenger(),
            STREAMCONNESSION);
    ...
    channelTransfer = new EventChannel(flutterPluginBinding.getBinaryMessenger(), STREAMTRANSFER);
   ...
   // mContext = flutterPluginBinding.getApplicationContext();
    switch(call.method){
      ...
      result.success(s);
        ...
        s ="settings"; 
       try{       
         init(mContext, height, bday, gender, user);
       }catch(Exception e){
         e.printStackTrace();
         s="ERROR";
       }
       result.success(s);
         ...
         s ="connect"; 
        try{       
        connectPeripheral(mPeripheralList.get(devicePosition),mContext);
        }catch(Exception e){
          e.printStackTrace();
          s="ERROR";
        }
