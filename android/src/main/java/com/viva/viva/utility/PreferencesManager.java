...
import com.viva.viva.models.PeripheralDevice;
...
public class PreferencesManager {
    ...
    *Get the list of devices stored in preferences
    ...
    public void saveDCIValue(long dci) {
            editor.putLong(KEY_DCI_VALUE, dci);
            editor.apply();

    }

    public long getDCIValue() {
        if (pref != null) {
            return pref.getLong(KEY_DCI_VALUE,-1);
        } else {
            return -1;
        }
    }
    ...
    public String getPartnerKey() {
        if (pref != null) {
            return pref.getString(KEY_PARTNER_KEY_VALUE,"");
        } else {
            return "";
        }
    }
